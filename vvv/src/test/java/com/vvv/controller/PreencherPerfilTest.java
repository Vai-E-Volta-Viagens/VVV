...
public class PreencherPerfilTest {
    ...
    @Test
    public void testPreencherPerfil() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/perfil"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.view().name("perfil"));
    }
}